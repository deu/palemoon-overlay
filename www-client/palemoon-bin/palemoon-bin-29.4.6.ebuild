...
SRC_URI="
	gtk2? ( https://archive.palemoon.org/${BIN_PN}/29.x/${PV}/${BIN_PN}-${PV}.linux-x86_64-gtk2.tar.xz )
	gtk3? ( https://archive.palemoon.org/${BIN_PN}/29.x/${PV}/${BIN_PN}-${PV}.linux-x86_64-gtk3.tar.xz )
"
